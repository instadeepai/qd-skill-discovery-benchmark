...
@hydra.main(config_path="config/pga_aurora", config_name="pointmaze")
def train(config: ExperimentConfig) -> None:
    ...
    _last_repertoire_dir = os.path.join(output_dir, "checkpoints", "last_repertoire")

    _repertoire_dir = os.path.join(output_dir, "checkpoints", "grid")
    _repertoire_img_dir = os.path.join(output_dir, "images", "me_repertoires")

    _timings_dir = os.path.join(output_dir, "timings")
    _init_state_dir = os.path.join(output_dir, "init_state")

    _passive_repertoire_dir = os.path.join(
        output_dir, "checkpoints", "passive_repertoire"
    )
    _passive_repertoire_img_dir = os.path.join(
        output_dir, "images", "passive_repertoire"
    )
    ...
    while iteration < num_loop_iterations:
        ...
        store_entire_me_repertoire = True
        if store_entire_me_repertoire:
